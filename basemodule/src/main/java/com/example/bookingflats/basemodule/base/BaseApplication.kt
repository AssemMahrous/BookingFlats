package com.example.bookingflats.basemodule.base

import android.app.Application
import androidx.annotation.CallSuper
import com.example.bookingflats.basemodule.BuildConfig
import com.example.bookingflats.basemodule.base.di.KoinMainModules
...
import java.util.*
import com.example.bookingflats.basemodule.utils.isDebug
    ...
    override fun onCreate() {
        ...
        if (isDebug) {
            val formatStrategy: FormatStrategy = PrettyFormatStrategy.newBuilder()
                ...
                .tag("BookingFlats") // (Optional) Global tag for every log. Default PRETTY_LOGGER
                .build()
