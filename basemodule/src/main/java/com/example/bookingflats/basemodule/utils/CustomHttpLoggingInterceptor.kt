...
class CustomHttpLoggingInterceptor @JvmOverloads constructor(
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        log += "<-- ${response.code}${if (response.message.isEmpty()) "" else ' ' + response.message} ${response.request.url} (${tookMs}ms${if (!logHeaders) ", $bodySize body" else ""})\n"
...
//                    val apply = Throwable(log).apply {
//                        stackTrace = arrayOf(StackTraceElement(
//                                method.declaringClass.name,
//                                method.name,
//                                "${method.declaringClass.simpleName}_${method.name}_${response.code}",
//                                1
//                        ))
//                    }
//                    Timber.e(apply)
//                    Log.e("test", "test", apply)
//                } catch (e: Exception) {
//                    Timber.e(e)
//                }
            }
